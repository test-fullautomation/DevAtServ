...
"""Python module containing the configuration for the DevAtServ test trigger.
"""
...
class CTestTriggerConfig():
   ...
   def __GetCommandLine(self):
      ...
      oCmdLineParser.add_argument('--robotcommandline', type=str, help='Command line for DevAtServ (optional).')
